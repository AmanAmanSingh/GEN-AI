...
vector_db = QdrantVectorStore.from_existing_collection(
    ...
    embedding=embedding_model #Tells LangChain which embedding model to use for converting queries when performing searches.
...
search_similar_results = vector_db.similarity_search(
    query = query
)
